...
const GalleryHarian1 = () => {
  ...
  const galleryItems = [
    {
      title: "KUNJUNGAN",
      image: "./FotoDaySiklus1/Day1/1.jpg",
    ...
    {
      title: "OBSERVASI",
      image: "./FotoDaySiklus1/Day1/2.jpg",
    ...
    {
      title: "PRA PEMBUKAAN",
      image: "./FotoDaySiklus1/Day1/3.jpg",
  ...
  const galleryItems2 = [
    {
      title: "PEMBUKAAN",
      image: "./FotoDaySiklus1/Day2/1.jpg",
    ...
    {
      title: "OBSERVASI",
      image: "./FotoDaySiklus1/Day2/2.JPG",
    ...
    {
      title: "OBSERVASI",
      image: "./FotoDaySiklus1/Day2/3.jpg",
      alt: "Survey Madrasah",
      description:
  ...
  const galleryItems3 = [
    {
      title: "MENGAJAR",
      image: "./FotoDaySiklus1/Day3/1.jpg",
    ...
    {
      title: "BIMBEL",
      image: "./FotoDaySiklus1/Day3/2.jpg",
      alt: "Kegiatan Bimbel",
      description:
    ...
    {
      title: "MENGAJI",
      image: "./FotoDaySiklus1/Day3/3.JPG",
  ...
  const galleryItems4 = [
    {
      title: "MENGAJAR",
      image: "./FotoDaySiklus1/Day4/1.JPG",
      alt: "Kegiatan Mengajar",
      description:
    ...
    {
      title: "MENGAJI",
      image: "./FotoDaySiklus1/Day4/2.JPG",
      alt: "Kegiatan Mengaji",
      description:
  ...
  const galleryItems5 = [
    {
      title: "JUM'AT BERSIH",
      image: "./FotoDaySiklus1/Day5/1.jpg",
      alt: "Kegiatan Jumsih",
      description:
    ...
    {
      title: "MENGAJAR",
      image: "./FotoDaySiklus1/Day5/2.JPG",
      alt: "Kegiatan Mengajar",
      description:
    ...
    {
      title: "MENGAJI",
      image: "./FotoDaySiklus1/Day5/3.jpg",
      alt: "Kegiatan Mengaji",
      description:
  ...
  const galleryItems6 = [
    {
      title: "MENGAJAR",
      image: "./FotoDaySiklus1/Day6/1.JPG",
      alt: "Kegiatan ngajar",
      description:
    ...
    },
    {
      ...
      image: "./FotoDaySiklus1/Day6/2.JPG",
  ...
  const galleryItems7 = [
    {
      ...
      image: "./FotoDaySiklus1/Day7/1.JPG",
  ...
  const galleryItems8 = [
    {
      ...
      image: "./FotoDaySiklus1/Day8/1.JPG",
      alt: "Kegiatan Kunjungan",
      description:
    ...
    {
      title: "BIMBEL",
      image: "./FotoDaySiklus1/Day8/2.png",
      alt: "Kegiatan Bimbel",
      description:
  ...
  const galleryItems9 = [
    {
      title: "FOTO BERSAMA",
      image: "./FotoDaySiklus1/Day9/1.JPG",
      alt: "Kegiatan Fotbar",
      description:
    ...
    },
    {
      ...
      image: "./FotoDaySiklus1/Day9/2.JPG",
    ...
    {
      title: "MENGAJI",
      image: "./FotoDaySiklus1/Day9/3.JPG",
      alt: "Kegiatan Mengaji",
      description:
  ...
  const galleryItems10 = [
    {
      title: "REMBUG WARGA",
      image: "./FotoDaySiklus1/Day10/1.JPG",
    ...
    {
      title: "MENGAJAR",
      image: "./FotoDaySiklus1/Day10/2.JPG",
      alt: "Kegiatan Mengajar",
      description:
