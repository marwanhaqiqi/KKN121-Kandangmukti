          ...
          <div className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row items-center">
              <div className="mb-6 md:mb-0 md:mr-6">
                <DocumentTextIcon className="h-20 w-20 text-blue-600" />
              </div>
              <div className="flex-1">
                ...
                <button className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition">
                  Download Sekarang
                </button>
              </div>
            </div>
