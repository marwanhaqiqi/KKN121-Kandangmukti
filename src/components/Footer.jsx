    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Tentang KKN</h3>
            <p className="text-gray-400 mb-4">
              Kuliah Kerja Nyata adalah bagian dari Tri Dharma Perguruan Tinggi
              yang bertujuan untuk pengabdian kepada masyarakat.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start">
                ...
                <span>kkn_desamandiri@univ.ac.id</span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <span>Balai Desa Mandiri, Kec. Maju Jaya, Kab. Sejahtera</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2023 Tim KKN Desa Mandiri. Hak Cipta Dilindungi.</p>
        </div>
      </div>
    </footer>
  );
